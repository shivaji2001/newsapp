    ...
    return (
      <div className='my-3'> 
        ...
        <div style={{display:'flex'  ,justifyContent:'flex-end',position:'absolute', right:'0' }}> <span className="badge rounded-pill bg-danger" >{source}</span> </div>
           ...
           <img src={imageUrl?imageUrl:"https://cdn.arstechnica.net/wp-content/uploads/2018/11/3D_Influenza_purple_no_key_full_lrg-760x380.jpg"} className="card-img-top" alt="..."/>
